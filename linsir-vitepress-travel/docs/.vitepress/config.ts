...
const teekConfig = defineTeekConfig({
  ...
  blogger: {
    // 博主信息，显示在首页侧边栏
    avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200",  //侧边栏个人头像 - 旅行者头像
    shape: "circle-rotate", // 头像风格：square 为方形头像，circle 为圆形头像，circle-rotate 可支持鼠标悬停旋转
    name: "旅行者", // 侧边栏个人昵称
    slogan: "用脚步丈量世界，用文字记录时光", // 侧边栏个人座右铭
    circleBgImg: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=800", // 侧边栏个人头像圆形背景图 - 风景图
    ...
    status: {
      icon: "✈️", // 状态图标
      size: 24, // 图标大小
      title: "在路上", // 鼠标悬停图标的提示语
    },    
  },

  // 首页 Banner 配置
  banner: {
    bgImage: CoverBgList, // 首页背景图
    mask: true, // 是否显示遮罩层
  },

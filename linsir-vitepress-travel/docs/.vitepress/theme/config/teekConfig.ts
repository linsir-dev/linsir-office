...
const teekBlogCommonConfig: TeekConfig = {
  ...
  banner: {
    enabled: true,
    name: "Linsir's Travel 🌍", // Banner 标题，默认读取 vitepress 的 title 属性
...
export const teekBlogCardConfig: TeekConfig = {
  ...
  homeCardListPosition: "none", // 隐藏侧栏
};

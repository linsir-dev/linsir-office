    ...
    return {
        ...
        initAmChart3: function() {
            ...
            var chart = AmCharts.makeChart("dashboard_amchart_3", {
                ...
                "graphs": [{
                    "alphaField": "alpha",
                    "balloonText": "<span style='font-size:12px;'>医保支付  [[category]]:<br><span style='font-size:20px;'>[[value]]</span> [[additional]]</span>",
                    "fillAlphas": 1,
                    "title": "Income",
                    "type": "column",
                    "valueField": "income",
                    ...
                    "id": "graph2",
                    "balloonText": "<span style='font-size:12px;'>医院支付  [[category]]:<br><span style='font-size:20px;'>[[value]]</span> [[additional]]</span>",
                    "bullet": "round",
                    "lineThickness": 3,
                    "bulletSize": 7,
                    "bulletBorderAlpha": 1,
